...
MOCK_DATA = {
    ...
    "appointments": [
        ...
        },
        {
            ...
            "hospital_id": "hosp-hoshiarpur-4",
            "hospital_name": "Saini Hospital & Trauma Centre",
            "department_id": "dept-4",
            "department_name": "Orthopedics & Joint Care",
            "appointment_date": "2026-09-10",
            "appointment_time": "11:15:00",
            "status": "completed",
            "reason": "Bilateral knee joint stiffness and arthritis check",
            "queue_number": 4,
            "notes": "X-ray confirmed Grade-2 OA. Prescribed Glucosamine, Calcium-D3 and physical therapy regimen.",
            "patient_rating": 5,
            "reminder_sent": True,
        ...
        },
        {
            ...
            "blood_group": "O+",
            "doctor_id": "doc-hsp-4",
            "doctor_name": "Dr. Manpreet Kaur",
            "hospital_id": "hosp-1",
            "hospital_name": "Civil Hospital Hoshiarpur",
            "department_id": "dept-3",
            "department_name": "Emergency & General Medicine",
            "appointment_date": "2026-08-25",
            "appointment_time": "09:45:00",
            "status": "completed",
            "reason": "Seasonal viral fever, acute body aches and dehydration",
            "queue_number": 8,
            "notes": "Dengue NS1 negative. Prescribed Paracetamol 650mg, hydration with ORS and resting protocol.",
            "patient_rating": 4,
            "reminder_sent": True,
        ...
        },
        {
            ...
            "status": "completed",
            "reason": "Annual preventive ECG & lipid profiling",
            "queue_number": 2,
            "notes": "Resting ECG normal sinus rhythm. Cholesterol borderline; advised lifestyle modification and low-sodium diet.",
            "patient_rating": 5,
            "reminder_sent": True,
